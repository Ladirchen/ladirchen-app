...
export const HOUSE_ACCESSORY_DEFINITIONS: ReadonlyArray<HouseAccessoryDefinition> = [
  ...
  defineIndoorFurniture({ id: 'kitchen-counter', icon: '🍳', price: 210, roomId: 'kitchen', setIds: ['family-kitchen-set'], mobility: 'fixed', visual: 'kitchen-counter', owned: true, equipped: true, defaultPlacement: { x: 38, y: 61, scale: .82 } }),
  defineIndoorFurniture({ id: 'retro-fridge', icon: '🧊', price: 150, roomId: 'kitchen', setIds: ['family-kitchen-set'], mobility: 'fixed', interaction: 'toggle-door', visual: 'retro-fridge', owned: true, equipped: true, defaultPlacement: { x: 76, y: 55, scale: .78 } }),
