...
export const HOUSE_ACCESSORY_DEFINITIONS: ReadonlyArray<HouseAccessoryDefinition> = [
  ...
  defineIndoorFurniture({ id: 'retro-fridge', icon: '🧊', price: 150, roomId: 'kitchen', setIds: ['family-kitchen-set'], mobility: 'fixed', interaction: 'toggle-door', visual: 'retro-fridge', owned: true, equipped: true, defaultPlacement: { x: 58, y: 37, scale: .78 } }),
